...
public class FluxRetryTest {
    ...
    @DisplayName("Shows effect of unlimited retry operator on Flux")
    void test01() {
    ...
    @Tag("unbounded demand")
    @Tag("infinite")
    @DisplayName("Shows effect of infinite repeat operator which resubscribe to given stream upon completion")
    void test04() {
        Flux.just(1, 2, 3)
                //.log()
                .repeat()
    ...
    @Tag("async")
    @Tag("unbounded demand")
    @DisplayName("Shows ability to cache infinite number of messages and replay them imidiatly upon subsciption")
    void test07() {
